...
public class MyProcessHandler extends ProcessHandler implements TaskExecutor {
    ...
    public static class ExecutorServiceHolder {
        private static final ThreadPoolExecutor ourThreadExecutorsService = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 1, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), ConcurrencyUtil.newNamedThreadFactory("OSProcessHandler pooled thread"));
